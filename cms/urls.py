...
urlpatterns = [
    ...
    url(r"cancellation-policy/$", cache_page(CACHE_MIDDLEWARE_SECONDS)(CancellationPolicyView.as_view()),
        name="cancellation-policy"),
    url(r"privacy-policy/$", cache_page(CACHE_MIDDLEWARE_SECONDS)(PrivacyPolicyView.as_view()), name="privacy-policy"),
    url(r"^(?P<site>[a-zA-Z0-9_.-]+)/$", cache_page(CACHE_MIDDLEWARE_SECONDS)(GenericView.as_view()),
