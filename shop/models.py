...
class OrderItem(models.Model):
    ...
    def total_wt(self):
        return calculate_sum(self.orderitem_set, True) if self.orderitem_set else 0 + self.price_wt

    def total(self):
        return calculate_sum(self.orderitem_set, False) if self.orderitem_set else 0 + self.price
