...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        category1,_ = ProductCategory.objects.get_or_create(name="Men", description="Mens clothing", is_main_category=True)
        category1.save()
        category11,_ = ProductCategory.objects.get_or_create(name="Shirts", description="Shirts", mother_category=category1)
        category11.save()
        category12,_ = ProductCategory.objects.get_or_create(name="Underwear", description="Underwear", mother_category=category1)
        category12.save()
        category13,_ = ProductCategory.objects.get_or_create(name="Trousers", description="Trousers", mother_category=category1)
        category13.save()
        ...
        category1.save()
        category2,_ = ProductCategory.objects.get_or_create(name="Women", description="Womens clothing", is_main_category=True)
        category2.save()
        category21,_ = ProductCategory.objects.get_or_create(name="Shirts", description="Shirts", mother_category=category2)
        category21.save()
        category22,_ = ProductCategory.objects.get_or_create(name="Underwear", description="Underwear", mother_category=category2)
        category22.save()
        category23,_ = ProductCategory.objects.get_or_create(name="Trousers", description="Trousers", mother_category=category2)
        category23.save()
